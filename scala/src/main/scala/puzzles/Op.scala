...
object Op {
  ...
  /**
    * >>> import puzzles.Op._
    * >>> Op.arg(Position(0), 100)
    * Immediate
    *
    * >>> Op.arg(Position(0), 102)
    * Immediate
    *
    * >>> Op.arg(Position(0), 2)
    * Absolute
    *
    * >>> Op.arg(Position(0), 10102)
    * Immediate
    *
    * >>> Op.arg(Position(1), 10102)
    * Absolute
    *
    * >>> Op.arg(Position(2), 10102)
    * Immediate
    *
    * >>> Op.arg(Position(2), 102)
    * Absolute
    *
    * >>> Op.arg(Position(0, 4), 202)(42)
  ...
  /**
    * >>> import cats.effect.IO
    * >>> import puzzles.Op._
    * >>> Op.fromIntCode(IO(0), Position(0), Memory.fromList(List(1002,5,3,0,99,33)))
    * Mul(Absolute(5),Immediate(3),Absolute(0))
    *
    * >>> Op.fromIntCode(IO(0), Position(0), Memory.fromList(List(1102, 2, -3, 4)))
    * Mul(Immediate(2),Immediate(-3),Absolute(4))
    *
    * >>> Op.fromIntCode(IO(0), Position(0), Memory.fromList(List(1099, 2, 3, 4)))
    * Halt(End())
    *
    * >>> Op.fromIntCode(IO(0), Position(1), Memory.fromList(List(42, 102, 2, 3, 4)))
